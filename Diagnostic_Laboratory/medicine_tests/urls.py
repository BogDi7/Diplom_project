...
app_name = 'medicine_tests'


urlpatterns = [

    path('all-medicine_tests/', all_tests, name='all-medicine_tests'),

    path('categories/', test_categories, name='categories'),

    path('categorise-medicine_tests/<int:id>/', categorise_tests, name='categorise-medicine_tests'),
    ...
    path('all-medicine_tests-list-staff/<username>/', all_tests_list_for_staff, name='all-medicine_tests-list-staff'),

    path('added-medicine_tests-list-staff-admin/<username>/', added_tests_list_for_staff_admin, name='added-medicine_tests-list-staff-admin'),
