...
from diagnostic.models import DiagnosticAdmin, DiagnosticStaff, DiagnosticCenter
...
def all_tests(request, template_name='medicine_tests/all_tests.html'):
...
def test_categories(request, template_name='medicine_tests/categories.html'):
...
def categorise_tests(request, id=None):
    ...
    template = 'medicine_tests/categorise_tests.html'
...
def test_details(request, id=id):
    ...
    template = 'medicine_tests/test_details.html'
...
def test_order(request, id=None):
    ...
    if request.method == 'POST':
        ...
        if test_order_form.is_valid():
            ...
            order.save()
            return redirect('medicine_tests:order-details', id=order.id)
    context = {
        'test_order_form': TestOrderForm(initial=initial_data),
        'test_id': id,
    }
    template = 'medicine_tests/order.html'
    return render(request, template, context)
...
def order_details_info(request, id=None):
    ...
    template = 'medicine_tests/order_details.html'
...
def staff_approved(request, id=None, username=None):
    ...
    return redirect('diagnostic:staff-dashboard', username=username)
...
def add_test_by_admin(request, username=None):
    if request.method == 'POST':
        ...
        if test_add_form.is_valid():
            ...
            return redirect('medicine_tests:added-medicine_tests-list-staff-admin', username)

    else:
        test_add_form = TestAddForm()

    template = 'medicine_tests/add_test.html'
...
def add_category_by_admin(request, username=None):
    if request.method == 'POST':
        ...
        if category_add_form.is_valid():
            ...
            return redirect('medicine_tests:filtered-categories-by-admin', username)

    else:
        category_add_form = CategoryAddForm()

    template = 'medicine_tests/add_category.html'
...
def edit_category(request, id=None, username=None):
    ...
    template = 'medicine_tests/edit_category.html'
...
def filtered_categories_by_admin(request, username=None):
    ...
    template = 'medicine_tests/filtered_categories_admin.html'
...
def filtered_categories_for_staff(request, username=None):
    ...
    template = 'medicine_tests/filtered_categories_staff.html'
...
def added_tests_list_for_staff_admin(request, username=None):
    ...
    template = 'medicine_tests/added_tests_list_for_staff_admin.html'
...
def edit_test(request, id=None, username=None):
    ...
    context = {'edit_form': edit_form}
    template = 'medicine_tests/edit_test.html'
...
def confirm_payment_message(request, id=None, username=None):
    ...
    template = 'medicine_tests/confirm_payment_message.html'
    context = {
        'order_details': order_details,
        'total_price': total_price,
...
def total_test_count_center_staff(request, id=None):
    ...
    template = 'medicine_tests/total_test_count/total_test_count_center_staff.html'
