...
from medicine_tests.models import TestOrder, Test
...
def search_paginator(request):
    ...
    template_name = 'diagnostic/all_centers.html'
...
def admin_login(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect('diagnostic:admin-dashboard', username)

        except DiagnosticAdmin.DoesNotExist:
            return redirect('diagnostic:admin-login')

    template = 'diagnostic/admin_login.html'
...
def admin_dashboard(request, username=None):
    ...
    template = 'diagnostic/admin_dashboard.html'
...
def staff_login(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect('diagnostic:staff-dashboard', username)

        except DiagnosticStaff.DoesNotExist:
            return redirect('diagnostic:staff-login')

    template = 'diagnostic/staff_login.html'
...
def staff_dashboard(request, id=None, username=None):
    ...
    template = 'diagnostic/staff_dashboard.html'
...
def center_details(request, id=id):
    ...
    template = 'diagnostic/center_details.html'
